...
from tools_train_predict import dice_coef, predictPatches, load_img_as_array
import yaml
...
#TODO create mask and save as raster
mask = load_img_as_array()

flat_truth = np.concatenate().flatten()
